...
class SimpleNetworkWithExciter(nn.Module):
    def __init__(self, input_size, exciter_neurons, hidden_size, output_size):
        ...
        self.hidden_layer = MaskedLinear(exciter_neurons)  # Enforce 1:1 masking
